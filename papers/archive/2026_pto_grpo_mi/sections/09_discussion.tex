...
optimizer family, the grader (\S\ref{ssec:winners}: the training oracle and a held-out judge
disagree about the top of this grid), and the task regime --- or be read as unscoped.
