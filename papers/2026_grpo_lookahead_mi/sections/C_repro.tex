...
code release, and the mapping from claim to table is a claims ledger released with it. Figures are copied from that same tree rather than regenerated here, so the draft compiles
...
Figures~\ref{fig:headline}, \ref{fig:overpraise}, \ref{fig:saturation}, \ref{fig:forest}
and~\ref{fig:tails}, each drawn at the width it is included at by a script in
