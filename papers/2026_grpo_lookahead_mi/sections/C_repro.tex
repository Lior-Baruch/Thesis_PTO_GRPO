...
ledger.
Figures are copied from that same tree rather than regenerated here, so the draft compiles
standalone and a submitted PDF is frozen against later re-renders.
