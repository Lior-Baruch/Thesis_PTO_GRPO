...
\ref{fig:headline}, \ref{fig:overpraise}, \ref{fig:forest} and~\ref{fig:tails} are drawn from
its tracked tables by scripts in the paper folder, at the width each is included at. The
