...
well as its last. This is the limitation a reader should weight most heavily. It is distinct from,
and not bounded by, the evaluation noise floor below.
...
Two noise floors bound this. At the untrained base, the two arms' independent draws of the
identical base policy differ on \QQ\ by $\dz\,0.115$ under the training oracle and $0.043$ under
the held-out judge, neither significant (Table~\ref{tab:byiter}), but that is measured where
sessions are short and homogeneous. At the \emph{trained} endpoint we re-drew the winning
...
it, and such a candidate gives the oracle a shorter transcript. Over the $121{,}088$ logged $\Kf$
candidates ($88\%$ of those scored), $82\%$ of rollouts ran the full five turns (the early-ending
share ranged from $12\%$ at iteration 10 to $30\%$ at iteration 6, and in $16\%$ of candidates the
patient closed);
...
(ICC 0.92--0.99 on the two $K{=}0$ states with a repeat draw), but repeatability is not validity. No human MI
