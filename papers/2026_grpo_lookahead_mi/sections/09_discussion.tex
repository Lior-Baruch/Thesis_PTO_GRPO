...
checkpoint a practitioner would ship, unseen by arm-level agreement. The diagnostic is
...
learned. Report the reward horizon as a hyperparameter, and watch the training grader's variance
as a statistic.
