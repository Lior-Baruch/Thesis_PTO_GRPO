...
the policy it just updated. We can show the compounding in the outcome (\S\ref{sec:reward}) and in
the behaviour (\S\ref{sec:behaviour}); isolating the pathway needs a cut this experiment does not
contain --- the same policy trained under both rewards with the horizon swapped mid-run.
