...
\citep{xie2024mctsdpo,yu2023promptmcts,yuan2024eurus}, to efficient planning over simulated
conversation continuations \citep{chen2025broaden}, and to the preference-tree formulation
...
Counselling quality is separable from language alone \citep{perezrosas2019goodcounselor},
LLM-simulated patients have been used to train and assess human counsellors
\citep{steenstra2025scaffolding}, and \citet{yosef2024assessing} validate the
questionnaire-filling evaluators we use as the reward. Ours is not a new MI system but a
measurement result about what happens when such an evaluator is optimised against for long
enough.
