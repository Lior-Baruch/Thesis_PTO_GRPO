...
Crucially this is an \emph{onset} curve rather than an endpoint accident: the arms are
indistinguishable for three iterations ($0.84$--$0.97$), then separate, with PTO holding
$0.80$--$0.98$ for the remainder while GRPO decays in trend to $0.28$. A policy drifting onto
grader-specific features is what that shape looks like, and it is legible four iterations
before the reward curve turns over (\S\ref{sec:heldout}).
