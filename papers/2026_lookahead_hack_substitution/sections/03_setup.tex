...
group) --- for instance the seven per-session MI-inconsistency quantities (six violation counts
plus their total) at iteration~8. Corrections are not pooled across iterations; each matched
iteration is its own family. We report per-session counts
