...
\S\ref{sec:cost}, which is precisely a contrast between a state this grader has saturated on and
one it has not. This failure mode --- one judge supplying both the reward and the reported
