...
_CODE_DIR = os.path.abspath(os.path.join(os.path.dirname(os.path.abspath(__file__)), ".."))
sys.path.insert(0, _CODE_DIR)  # code/ (this file lives in code/tools/ since 2026-08-18) so `_shared` + `roles` resolve
