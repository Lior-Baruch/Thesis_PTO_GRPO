...
See [`figures/headline/outcomes_headline.png`](figures/headline/outcomes_headline.png),
[`figures/headline/effect_vs_base_forest.png`](figures/headline/effect_vs_base_forest.png),
[`figures/headline/trajectory_Q1Q2.png`](figures/headline/trajectory_Q1Q2.png), and
[`tables/stats/main_results_final.md`](tables/stats/main_results_final.md).
...
- **PTO ahead at the matched 10-iter endpoint.** Paired PTO−GRPO at iter 10: **Q1+Q2 +0.51**
  ...
  [`tables/stats/PTO_vs_GRPO_LA0_paired.md`](tables/stats/PTO_vs_GRPO_LA0_paired.md). The earlier
...
- **Climb rate.** OLS Q1+Q2 slope PTO **0.120/iter** (peak = final iter 10) vs GRPO **0.072/iter**
  (peak iter 8) — [`tables/stats/Q1Q2_slope_by_arm.md`](tables/stats/Q1Q2_slope_by_arm.md). With
...
See [`figures/eval/factor_loadings.png`](figures/eval/factor_loadings.png),
[`figures/eval/rubric_correlation.png`](figures/eval/rubric_correlation.png), and
[`tables/eval/leaderboard_scorecard.md`](tables/eval/leaderboard_scorecard.md).
...
See [`figures/eval/behavior_drift.png`](figures/eval/behavior_drift.png) and the per-arm tables
under [`tables/eval/`](tables/eval/).
...
- **Across all 96 iter-10 conversations** (per-arm behaviour tables under `tables/eval/`): GRPO
...
- Both arms kill the early degeneration loops (loop% 0.49 → 0); the leak/empty health gate stays
  clean (see [`figures/training/`](figures/training/)).

## 5. Is the training reward faithful?
See [`figures/reliability/reward_reliability_curve.png`](figures/reliability/reward_reliability_curve.png).
...
See [`figures/preference/`](figures/preference/). The mean(chosen − rejected) direction genuinely
