...
def _refresh_root_index() -> str:
    ...
    lines = ["# Exp3 EDA results — family map\n",
             ...
             "(`results/<top>/<sub>/`), counts over every judge leaf. Each `<top>/` folder has its "
             "own `INDEX.md` (artifact list with captions) and a hand-authored `SUMMARY.md`. "
             "`METRICS_REFERENCE.md`, `LIMITATIONS.md` and `schematics/` are hand-authored and "
             "never regenerated._\n",
