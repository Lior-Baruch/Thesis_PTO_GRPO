...
| [`2026_pto_grpo_mi/`](papers/2026_pto_grpo_mi/) | *Same Lever, Different Optimizer* — the reward-horizon $\times$ optimizer interaction: the optimizer ranking flips with $K$ (iterations-only axis) | Exp3, all four arms, both graders | **THE submission — the single live paper, ARR October 2026** (submission 2026-10-12; feeds NAACL 2027 + COLING 2027) |
| [`archive/2026_grpo_lookahead_mi/`](papers/archive/2026_grpo_lookahead_mi/) | *Scoring the Continuation* — does $K$-turn look-ahead help a **group-relative** optimizer, and what does it change about the policy's behaviour? | Exp3, the two GRPO arms, both graders | retired 2026-08-27 — the supervisors chose a single ARR submission; its argument survives inside the live 2×2 paper |
