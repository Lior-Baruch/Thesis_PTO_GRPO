...
| [`2026_grpo_lookahead_mi/`](papers/2026_grpo_lookahead_mi/) | *Scoring the Continuation* — does $K$-turn look-ahead help a **group-relative** optimizer, at what budget, and what does it change about the policy's behaviour? | Exp3, the two GRPO arms, both graders | **drafting — the live draft, targeting ICLR 2027** (abstract 2026-09-18, paper 2026-09-25) |
