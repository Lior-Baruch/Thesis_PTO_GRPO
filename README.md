...
| [`2026_grpo_lookahead_mi/`](papers/2026_grpo_lookahead_mi/) | *Scoring the Continuation* — GRPO with $K$-turn look-ahead: does scoring the continuation help a **group-relative** optimizer, and what does it change about the policy's behaviour? PTO cited as the lever's origin, never data | Exp3, the two GRPO arms, both graders | **live — revived 2026-08-27 as a second ARR October 2026 submission** (ACL format, iterations-only) |
